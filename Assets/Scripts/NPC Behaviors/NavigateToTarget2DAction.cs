...
[NodeDescription(name: "Navigate To Target 2D", story: "[Agent] navigates to [Target]", category: "Action/Navigation", id: "d86f85317fb75f9f9ee1bc9e4708433c")]
public partial class NavigateToTarget2DAction : Action
{
    ...
    protected override Status OnStart()
    {
        ...
        Location.Value = new Vector2(Target.Value.transform.position.x, Target.Value.transform.position.y);
